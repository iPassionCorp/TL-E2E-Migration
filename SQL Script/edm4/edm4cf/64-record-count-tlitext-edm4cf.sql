...
select count(0) AS clrctrl from tlitext.clrctrl;
select count(0) AS mgcfpolicy from tlitext.mgcfpolicy;
select count(0) AS mgcfpay from tlitext.mgcfpay;
select count(0) AS queue from tlitext.queue;
